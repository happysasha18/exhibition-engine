...
| The bake strips comments from the served `exhibition.css` (2026-07-23) and `exhibition.js` (1.14.0); the source keeps every comment and every served line is a source line, in order | resolved (as-shipped) | this doc's Quality budgets section; `tests/test_budget.py` |
