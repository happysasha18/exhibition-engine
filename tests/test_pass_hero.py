...
check("PASS-HERO the port's own numbers are named as its own, and each is the arc",
      ...
      and "var FOLD_FLOOR = 0.5;" in REGION,
      ...
      "of the story, so the arriving work comes in whatever far end the pair's reading gives; "
      "FOLD_FLOOR is the composer's own DEVICE_LEGIBLE")
...
check("PASS-HERO every geometric handle publishes the measurement of the work it reads",
      ...
      and 'applied: { floor: FOLD_FLOOR }' in REGION,
      ...
      "own turn, gated by `structure.rotational.score`; the far end of the arc is placed by "
