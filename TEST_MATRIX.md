...
## §3a — Naряд S-16 closed, 2026-08-28

Eight of the fourteen rows above (PASS-01, 08, 09, 10, 11, 12, 13, 14) now have real tests or a
real, confirmed reason none exists (PASS-14). Six (PASS-02 through PASS-07) still read "Declared
and unbuilt": they project ElementSet multi-actor casting and the `middle` world/surface cue, and
neither exists in this engine. Building either is a new engine capability nobody has asked to
ship — it is a product decision, not a testing gap, and наряд S-16 closes without it. These six
rows stay in the matrix as an honest record of what the spec's `EX-PASS-COMPOSER`/`EX-PASS-VOICE`
prose already promises against what the composer does not yet build; a future наряд that decides
to build ElementSet casting or a middle cue starts here, with the test rows already waiting.
