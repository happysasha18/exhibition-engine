...
(function () {
  ...
  function veilInstrument() {
    ...
    /* THE DEAD BANDS AT EITHER END OF THE HAND, the number every instrument of this engine uses.
       Over the first and last five hundredths of the dial the two works stand at the two ends of
       their travel and neither has begun to move, so the standing work is the picture its source
