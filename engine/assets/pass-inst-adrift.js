    ...
    var manifest = {
      ...
      handles: {
        ...
        mix: { min: 0, max: 1, def: 0, level: null,
               curve: { knots: FEEL_MIX, band: FEEL_D0, applied: true } },
      ...
      resources: { lean: { textures: 0, textureSlots: 2, framebuffers: 0, pingPong: 0,
                   programs: 1, passes: 1, bytesEstimate: 2000204, variant: "lean" },
                   standard: { textures: 0, textureSlots: 2, framebuffers: 0, pingPong: 0,
                               programs: 1, passes: 1, bytesEstimate: 8000204,
                               variant: "standard" },
                   rich: { textures: 0, textureSlots: 2, framebuffers: 0, pingPong: 0, programs: 1,
                           passes: 1, bytesEstimate: 32000204, variant: "rich" } },
      capabilities: ["webgl2"],
